...
class MessageTableViewController: UITableViewController {
        ...
        func updateTabCounter() {
            ...
            for message in self.messages {
                total += message.objectForKey("Counter") as! Int
            }
        ...
        */
        ...
        override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
            var cell = tableView.dequeueReusableCellWithIdentifier("messagesCell") as! MessageTableViewCell
        ...
        override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
            ...
            self.openChat(message.objectForKey("GroupID") as! String)
        }
