...
public class TimelineView: UIView {
    ...
    */
     ...
     */
    public var titleLabelColor: UIColor = UIColor(red: 0/255, green: 161/255, blue: 176/255, alpha: 1.0){
        didSet{
            setupContent()
        }
    }
    ...
    */
    ...
    private func setupContent(){
        ...
        addConstraints([
            NSLayoutConstraint(item: guideView, attribute: .Top, relatedBy: .Equal, toItem: self, attribute: .Top, multiplier: 1.0, constant: 5),
    ...
    private func blockForTimeFrame(element: TimeFrame, imageTag: Int) -> UIView{
        ...
        textLabel.font = UIFont(name: "Avenir", size: 12)
